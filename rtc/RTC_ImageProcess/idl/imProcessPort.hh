...
public:
  ...
  static _dyn_attr const ::CORBA::TypeCode_ptr _tc_MultiImage;

  typedef RTC::CameraImage MultiImage[4];
  typedef RTC::CameraImage MultiImage_slice;

  static inline MultiImage_slice* MultiImage_alloc() {
    return new MultiImage_slice[4];
  }

  static inline MultiImage_slice* MultiImage_dup(const MultiImage_slice* _s) {
    if (!_s) return 0;
    MultiImage_slice* _data = MultiImage_alloc();
    if (_data) {
  ...
  static inline void MultiImage_copy(MultiImage_slice* _to, const MultiImage_slice* _from){
    for (_CORBA_ULong _0i0 = 0; _0i0 < 4; _0i0++){
  ...
  static inline void MultiImage_free(MultiImage_slice* _s) {
    delete [] _s;
  }

  class MultiImage_copyHelper {
  public:
    static inline MultiImage_slice* alloc() { return ::ComImProcess::MultiImage_alloc(); }
    static inline MultiImage_slice* dup(const MultiImage_slice* p) { return ::ComImProcess::MultiImage_dup(p); }
    static inline void free(MultiImage_slice* p) { ::ComImProcess::MultiImage_free(p); }
  };

  typedef _CORBA_Array_Variable_Var<MultiImage_copyHelper,MultiImage_slice> MultiImage_var;
  typedef _CORBA_Array_Variable_Forany<MultiImage_copyHelper,MultiImage_slice> MultiImage_forany;

  typedef _CORBA_Array_Variable_OUT_arg<MultiImage_slice,MultiImage_var > MultiImage_out;
...
public:
  ...
  virtual ComImProcess::MultiImage_slice* get_colorImage(::CORBA::Short CameraBitMask, ::CORBA::Boolean& ref) = 0;
  virtual ComImProcess::MultiImage_slice* get_irImage(::CORBA::Short CameraBitMask, ::CORBA::Boolean& ref) = 0;
  virtual ComImProcess::MultiImage_slice* get_ir_rightImage(::CORBA::Short CameraBitMask, ::CORBA::Boolean& ref) = 0;
  virtual ComImProcess::MultiImage_slice* get_depthImage(::CORBA::Short CameraBitMask, ::CORBA::Boolean& ref) = 0;
  virtual ::CORBA::Boolean save_colorImage(::CORBA::Short CameraBitMask, const char* str) = 0;
  virtual ::CORBA::Boolean save_irImage(::CORBA::Short CameraBitMask, const char* str) = 0;
  virtual ::CORBA::Boolean save_ir_rightImage(::CORBA::Short CameraBitMask, const char* str) = 0;
  virtual ::CORBA::Boolean save_depthImage(::CORBA::Short CameraBitMask, const char* str) = 0;
...
_CORBA_Boolean operator>>=(const ::CORBA::Any& _a, ComImProcess::MultiImage_forany& _s);
